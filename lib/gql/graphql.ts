...
export type AssignCsManagerTargetMutation = { __typename?: 'Mutation', assignCSManagerTarget: { __typename?: 'CSManagerTargetType', _id: string, manager: string, month: number, year: number, customers_allocated_target: number, customers_onboarded_target: number, deeds_delivered_target: number, createdAt?: any | null, updatedAt?: any | null } };
...
export type ListCsManagerTargetsQuery = { __typename?: 'Query', listCSManagerTargets: Array<{ __typename?: 'CSManagerTargetType', _id: string, manager: string, month: number, year: number, customers_allocated_target: number, customers_onboarded_target: number, deeds_delivered_target: number, createdAt?: any | null, updatedAt?: any | null }> };
...
export type GetCsManagerTargetQuery = { __typename?: 'Query', getCSManagerTarget?: { __typename?: 'CSManagerTargetType', _id: string, manager: string, month: number, year: number, customers_allocated_target: number, customers_onboarded_target: number, deeds_delivered_target: number, createdAt?: any | null, updatedAt?: any | null } | null };
