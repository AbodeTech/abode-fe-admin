...
export type AdminSessionQuery = { __typename?: 'Query', adminSession: { __typename?: 'AdminSession', _id: string, userName?: string | null, email: string, role: string, isCSManager: boolean, canRouteTickets: boolean, permissions: Array<string> } };
