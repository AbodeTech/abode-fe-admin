...
export type ProfilepicInput = {
  image_base64: Scalars['String']['input'];
...
export type CreatePlotsMutation = { __typename?: 'Mutation', createPlots: Array<number> };
