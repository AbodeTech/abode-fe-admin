...
export type ChangeAssetLocationAssetQuestionInput = {
  address?: InputMaybe<Scalars['String']['input']>;
  desired_landuse: Scalars['String']['input'];
  mode_of_communication: Scalars['String']['input'];
  name_of_property: Scalars['String']['input'];
  source_of_funds: Scalars['String']['input'];
};

export type ChangeAssetLocationInput = {
  assetQuestion: ChangeAssetLocationAssetQuestionInput;
  currentUniqueAssetId: Scalars['String']['input'];
  newAmountPaid: Scalars['Float']['input'];
  newAssetId: Scalars['ID']['input'];
  newAssetPrice: Scalars['Float']['input'];
  newAssetType: Scalars['String']['input'];
  newDocumentAmountPaid?: InputMaybe<Scalars['Float']['input']>;
  newDocumentMonthlyInstallment?: InputMaybe<Scalars['Float']['input']>;
  newDocumentPrice?: InputMaybe<Scalars['Float']['input']>;
  newDurationMonths?: InputMaybe<Scalars['Int']['input']>;
  newMonthSubscription: Scalars['Int']['input'];
  newMonthlyInstallment: Scalars['Float']['input'];
  newNoOfUnits: Scalars['Int']['input'];
  newSize: Scalars['Float']['input'];
  reason?: InputMaybe<Scalars['String']['input']>;
  userId: Scalars['ID']['input'];
};

export type ChangeAssetLocationResponse = {
  __typename?: 'ChangeAssetLocationResponse';
  message: Scalars['String']['output'];
  newUniqueAssetId: Scalars['String']['output'];
  success: Scalars['Boolean']['output'];
};
...
export type Mutation = {
  ...
  changeAssetLocation: ChangeAssetLocationResponse;
...
export type MutationChangeAssetLocationArgs = {
...
export type UserAdminDetail = {
  ...
  amount_paid?: Maybe<Scalars['Float']['output']>;
  amount_payable?: Maybe<Scalars['Float']['output']>;
  associate_manager?: Maybe<UserAssociateManagerInfo>;
...
export type UserAssociateManagerInfo = {
  __typename?: 'UserAssociateManagerInfo';
  email?: Maybe<Scalars['String']['output']>;
  firstName?: Maybe<Scalars['String']['output']>;
  id?: Maybe<Scalars['ID']['output']>;
  lastName?: Maybe<Scalars['String']['output']>;
...
export type AdminGetManagerDashboardQuery = { __typename?: 'Query', adminGetManagerDashboard: { __typename?: 'ManagerDashboardResponse', period: { __typename?: 'ManagerDashboardPeriod', periodType: PeriodType, month?: number | null, year?: number | null, start: any, end: any }, target: { __typename?: 'ManagerDashboardTarget', recruitedTarget: number, recruitedSoFar: number, sellingTarget: number, sellingSoFar: number, performanceScoreTarget: number, performanceScoreSoFar: number }, recruitment: { __typename?: 'ManagerDashboardRecruitment', newSignupsInPeriod: number, upgradesInPeriod: number, onboardedInPeriod: number, totalAssigned: number }, salesAndRevenue: { __typename?: 'ManagerDashboardSalesRevenue', sellingPros: number, sellingProsTarget: number, totalRevenue: number, initialSalesRevenue: number, recurringRevenue: number, revenuePerSellingPro: number }, activity: { __typename?: 'ManagerDashboardActivity', activeCount: number, activePct: number, recentLoginCount: number, recentSaleCount: number, recentRecruitCount: number, inactiveCount: number, inactivePct: number, abandonedCount: number, abandonedPct: number }, milestones: { __typename?: 'ManagerDashboardMilestones', earlySellers: number, lateFirstSellers: number }, performanceScore: { __typename?: 'ManagerDashboardPerformanceScore', target: number, actual: number }, associatePros: Array<{ __typename?: 'ManagerDashboardProRow', id: string, firstName?: string | null, lastName?: string | null, email?: string | null, phoneNumber?: string | null, status: string, dateRecruited?: any | null, totalSales: number, revenueGenerated: number, lastLogin?: any | null, onboardedAt?: any | null }> } };
...
export type ManagerDashboardQuery = { __typename?: 'Query', managerDashboard: { __typename?: 'ManagerDashboardResponse', period: { __typename?: 'ManagerDashboardPeriod', periodType: PeriodType, month?: number | null, year?: number | null, start: any, end: any }, target: { __typename?: 'ManagerDashboardTarget', recruitedTarget: number, recruitedSoFar: number, sellingTarget: number, sellingSoFar: number, performanceScoreTarget: number, performanceScoreSoFar: number }, recruitment: { __typename?: 'ManagerDashboardRecruitment', newSignupsInPeriod: number, upgradesInPeriod: number, onboardedInPeriod: number, totalAssigned: number }, salesAndRevenue: { __typename?: 'ManagerDashboardSalesRevenue', sellingPros: number, sellingProsTarget: number, totalRevenue: number, initialSalesRevenue: number, recurringRevenue: number, revenuePerSellingPro: number }, activity: { __typename?: 'ManagerDashboardActivity', activeCount: number, activePct: number, recentLoginCount: number, recentSaleCount: number, recentRecruitCount: number, inactiveCount: number, inactivePct: number, abandonedCount: number, abandonedPct: number }, milestones: { __typename?: 'ManagerDashboardMilestones', earlySellers: number, lateFirstSellers: number }, performanceScore: { __typename?: 'ManagerDashboardPerformanceScore', target: number, actual: number }, associatePros: Array<{ __typename?: 'ManagerDashboardProRow', id: string, firstName?: string | null, lastName?: string | null, email?: string | null, phoneNumber?: string | null, status: string, dateRecruited?: any | null, totalSales: number, revenueGenerated: number, lastLogin?: any | null, onboardedAt?: any | null }> } };
...
export type GetSystemAssociatesDashboardQuery = { __typename?: 'Query', getSystemAssociatesDashboard: { __typename?: 'ManagerDashboardResponse', period: { __typename?: 'ManagerDashboardPeriod', periodType: PeriodType, month?: number | null, year?: number | null, start: any, end: any }, recruitment: { __typename?: 'ManagerDashboardRecruitment', newSignupsInPeriod: number, upgradesInPeriod: number, onboardedInPeriod: number, totalAssigned: number }, salesAndRevenue: { __typename?: 'ManagerDashboardSalesRevenue', sellingPros: number, sellingProsTarget: number, totalRevenue: number, initialSalesRevenue: number, recurringRevenue: number, revenuePerSellingPro: number }, activity: { __typename?: 'ManagerDashboardActivity', activeCount: number, activePct: number, recentLoginCount: number, recentSaleCount: number, recentRecruitCount: number, inactiveCount: number, inactivePct: number, abandonedCount: number, abandonedPct: number }, milestones: { __typename?: 'ManagerDashboardMilestones', earlySellers: number, lateFirstSellers: number }, performanceScore: { __typename?: 'ManagerDashboardPerformanceScore', target: number, actual: number }, associatePros: Array<{ __typename?: 'ManagerDashboardProRow', id: string, firstName?: string | null, lastName?: string | null, email?: string | null, phoneNumber?: string | null, status: string, dateRecruited?: any | null, totalSales: number, revenueGenerated: number, lastLogin?: any | null, onboardedAt?: any | null }> } };
...
export type ChangeAssetLocationMutationVariables = Exact<{
  input: ChangeAssetLocationInput;
}>;


export type ChangeAssetLocationMutation = { __typename?: 'Mutation', changeAssetLocation: { __typename?: 'ChangeAssetLocationResponse', success: boolean, message: string, newUniqueAssetId: string } };

export type DestinationAssetsForTransferQueryVariables = Exact<{ [key: string]: never; }>;


export type DestinationAssetsForTransferQuery = { __typename?: 'Query', viewAllWebsiteAssets?: { __typename?: 'AssetResponse', data?: Array<{ __typename?: 'Assets', _id: string, asset_name?: string | null, asset_location?: string | null, asset_type?: string | null, sold?: boolean | null, new_asset?: boolean | null, asset_option?: Array<{ __typename?: 'AssetOption', size?: number | null, unit?: string | null, price?: number | null, zero_months?: number | null, one_month?: number | null, three_months?: number | null, six_months?: number | null, five_months?: number | null, twelve_months?: number | null, flex_payment_plans?: Array<{ __typename?: 'FlexPaymentPlan', duration_months: number, monthly_installment: number, price?: number | null, unit?: number | null } | null> | null } | null> | null } | null> | null } | null };
...
export const ChangeAssetLocationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ChangeAssetLocation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ChangeAssetLocationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"changeAssetLocation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"newUniqueAssetId"}}]}}]}}]} as unknown as DocumentNode<ChangeAssetLocationMutation, ChangeAssetLocationMutationVariables>;
export const DestinationAssetsForTransferDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DestinationAssetsForTransfer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"viewAllWebsiteAssets"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"asset_name"}},{"kind":"Field","name":{"kind":"Name","value":"asset_location"}},{"kind":"Field","name":{"kind":"Name","value":"asset_type"}},{"kind":"Field","name":{"kind":"Name","value":"sold"}},{"kind":"Field","name":{"kind":"Name","value":"new_asset"}},{"kind":"Field","name":{"kind":"Name","value":"asset_option"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"size"}},{"kind":"Field","name":{"kind":"Name","value":"unit"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"flex_payment_plans"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"duration_months"}},{"kind":"Field","name":{"kind":"Name","value":"monthly_installment"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"unit"}}]}},{"kind":"Field","name":{"kind":"Name","value":"zero_months"}},{"kind":"Field","name":{"kind":"Name","value":"one_month"}},{"kind":"Field","name":{"kind":"Name","value":"three_months"}},{"kind":"Field","name":{"kind":"Name","value":"six_months"}},{"kind":"Field","name":{"kind":"Name","value":"five_months"}},{"kind":"Field","name":{"kind":"Name","value":"twelve_months"}}]}}]}}]}}]}}]} as unknown as DocumentNode<DestinationAssetsForTransferQuery, DestinationAssetsForTransferQueryVariables>;
