...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar w-full p-2 sm:w-fit sm:p-3",
        "[--cell-size:2.25rem] min-[380px]:[--cell-size:2.5rem] sm:[--cell-size:--spacing(8)]",
      ...
      classNames={{
        ...
        month: cn("flex w-full min-w-0 flex-col gap-3 sm:gap-4", defaultClassNames.month),
        nav: cn(
        ...
        week: cn("mt-1.5 flex w-full sm:mt-2", defaultClassNames.week),
        ...
        day: cn(
          "relative aspect-square h-auto w-full min-w-0 flex-1 p-0 text-center select-none group/day",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "flex aspect-square size-auto h-full w-full min-w-0 flex-col gap-0.5 leading-none font-normal",
        ...
        "dark:hover:text-accent-foreground [&>span]:text-[0.65rem] [&>span]:opacity-70 sm:[&>span]:text-xs",
        defaultClassNames.day,
        className
      )}
      {...props}
