...
interface PaginationProps {
  ...
  limit?: number;
  /**
   * Search param this pager reads and writes. Defaults to `page`; pass a
   * distinct name when a screen pages two tables independently, so one
   * table's pager doesn't move the other.
   */
  pageParam?: string;
}
