...
interface PaymentPlanGeneratorProps<T extends FieldValues> {
...
export function PaymentPlanGenerator<T extends FieldValues>({
  form,
  open,
  onOpenChange,
  optionIndex,
            ...
            {optionIndex !== -1 &&
              (() => {
                const plans = form.watch(
                  `asset_option.${optionIndex}.flex_payment_plans` as Path<T>
                ) as unknown as FlexPaymentPlan[];
