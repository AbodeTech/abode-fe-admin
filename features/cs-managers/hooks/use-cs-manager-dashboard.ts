...
const MOCK_MANAGERS: Record<string, CSManagerDashboard> = {
  adenike: {
    ...
    customers: [
      {
        id: "c1", firstName: "Ademola", lastName: "Ojo",
        email: "ademola.ojo@gmail.com",
        estate: "Amara Estates", product: "flex",
      ...
      {
        id: "c2", firstName: "Ebuka", lastName: "Nwosu",
        email: "ebuka.nwosu@yahoo.com",
        estate: "Coastal View", product: "full-ownership",
      ...
      {
        id: "c3", firstName: "Funmi", lastName: "Idowu",
        email: "funmi.idowu@abode.ng",
        estate: "Coastal View", product: "flex",
        paymentStatus: "completed", paymentLabel: "Completed",
        onboarding: "confirmed",
      ...
      {
        id: "c4", firstName: "Chiamaka", lastName: "Johnson",
        email: "chi.johnson@gmail.com",
        estate: "Amara Estates", product: "full-ownership",
      ...
      {
        id: "c5", firstName: "David", lastName: "Okafor",
        email: "david.okafor@outlook.com",
        estate: "Serene Ridge", product: "flex",
        paymentStatus: "completed", paymentLabel: "Completed",
        onboarding: "disputed",
        allocation: "not_applicable",
        doa: "not_applicable",
      ...
      {
        id: "c6", firstName: "Tomiwa", lastName: "Adebayo",
        email: "tomiwa.a@gmail.com",
        estate: "Coastal View", product: "full-ownership",
        paymentStatus: "completed", paymentLabel: "Completed",
        onboarding: "confirmed",
